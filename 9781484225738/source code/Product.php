...
class ProductCore extends ObjectModel
{
    ...
    public static $definition = array(
        ...
        'fields' => array(
			...
			'booking_dates' =>            array('type' => self::TYPE_STRING, 'shop' => true, 'validate' => 'isGenericName'),
    ...
    public static function addCustomizationPrice(&$products, &$customized_datas)
    {
        ...
        foreach ($products as &$product_update) {
            if (!Customization::isFeatureActive()) {
				...
				$balance_due_product = Product::getPriceStatic(
					$product_id,
				...
				$price_wt += $balance_due_product;
				$price += $balance_due_product;
