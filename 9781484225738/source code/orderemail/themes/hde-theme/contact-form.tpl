...
*}
{capture name=path}{l s='Contactme por fa'}{/capture}
<h1 class="page-heading bottom-indent">
	{l s='Customer serviceto'} - {if isset($customerThread) && $customerThread}{l s='Your reply'}{else}{l s='Contact us'}{/if}
</h1>
...
{else}
	...
	<form action="{$request_uri}" method="post" class="contact-form-box" enctype="multipart/form-data">
		<fieldset>
			<h3 class="page-subheading">{l s='send a messageeeeee'}</h3>
			<div class="clearfix">
