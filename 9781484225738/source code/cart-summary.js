...
function updateCartSummary(json)
{
	...
	$('#total_due').html(formatCurrency(json.total_due, currencyFormat, currencySign, currencyBlank));
	$('#total_deposit').html(formatCurrency(json.total_deposit, currencyFormat, currencySign, currencyBlank));
